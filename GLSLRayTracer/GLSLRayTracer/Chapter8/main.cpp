...
float cameraTarget[] = { 0.0f, 0.0f, -1.0f };
...
void renderScene()
{
	...
	shaderProgram.SetUniform3f("cameraTarget", cameraTarget[0], cameraTarget[1], cameraTarget[2]);
	shaderProgram.SetUniform3f("cameraUp", cameraUp[0], cameraUp[1], cameraUp[2]);
